...
const goToSuperImplementationHandler = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return vscode_1.commands.executeCommand(commands_1.builtInCommands.goToEditorLocations, vscode_1.window.activeTextEditor.document.uri, position, locations.map(location => new vscode_1.Location(utils_1.FileUtils.toUri(location.uri, true), new vscode_1.Range(location.range.start.line, location.range.start.character, location.range.end.line, location.range.end.character))), 'peek', localiser_1.l10n.value('jdk.extension.error_msg.noSuperImpl'));
});
...
const workspaceSymbolsHandler = (query) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const client = yield globalState_1.globalState.getClientPromise().client;
    return (_a = (yield client.sendRequest("workspace/symbol", { "query": query }))) !== null && _a !== void 0 ? _a : [];
});
