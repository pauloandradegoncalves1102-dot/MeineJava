...
exports.extCommands = {
    ...
    openLanguageServerUserDir: (0, utils_1.appendPrefixToCommand)('open.userDir'),
    downloadJdk: (0, utils_1.appendPrefixToCommand)('download.jdk'),
    selectJdk: (0, utils_1.appendPrefixToCommand)('select.jdk'),
    ...
    projectTestDebug: (0, utils_1.appendPrefixToCommand)('project.test.debug'),
    ...
    createNotebook: (0, utils_1.appendPrefixToCommand)("notebook.new"),
    openJshellInProject: (0, utils_1.appendPrefixToCommand)("jshell.project"),
    notebookChangeProjectContext: (0, utils_1.appendPrefixToCommand)("notebook.change.project"),
    resetNotebookSession: (0, utils_1.appendPrefixToCommand)("notebook.restart.kernel"),
};
...
exports.nbCommands = {
    ...
    openStackTrace: (0, utils_1.appendPrefixToCommand)('open.stacktrace'),
    executeNotebookCell: (0, utils_1.appendPrefixToCommand)("jshell.execute.cell"),
    interruptNotebookCellExecution: (0, utils_1.appendPrefixToCommand)("jshell.interrupt.cell"),
    openJshellInProject: (0, utils_1.appendPrefixToCommand)("jshell.project.open"),
    createNotebookProjectContext: (0, utils_1.appendPrefixToCommand)("notebook.project.context"),
    resetNotebookSession: (0, utils_1.appendPrefixToCommand)("notebook.reset.session")
};
