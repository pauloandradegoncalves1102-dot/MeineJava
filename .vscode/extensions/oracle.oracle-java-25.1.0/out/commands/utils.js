...
exports.wrapCommandWithProgress = exports.wrapProjectActionWithProgress = exports.isNbCommandRegistered = exports.getContextUriFromFile = void 0;
/*
...
const getContextUriFromFile = (ctx) => {
    var _a, _b;
    ...
    if ((0, utils_1.isString)(ctx)) {
        return utils_1.FileUtils.toUri(ctx, true);
    }
    return (_b = (_a = vscode_1.window.activeTextEditor) === null || _a === void 0 ? void 0 : _a.document) === null || _b === void 0 ? void 0 : _b.uri;
};
exports.getContextUriFromFile = getContextUriFromFile;
