...
const newFromTemplate = (ctx, template) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (yield (0, utils_1.isNbCommandRegistered)(commands_1.nbCommands.newFromTemplate)) {
        ...
        if (!workspaces) {
            ...
            const folderPathUri = utils_2.FileUtils.toUri(folderPath);
        ...
        params.push((_a = (0, utils_1.getContextUriFromFile)(ctx)) === null || _a === void 0 ? void 0 : _a.toString(), (_d = (_c = (_b = vscode_1.window.activeTextEditor) === null || _b === void 0 ? void 0 : _b.document) === null || _c === void 0 ? void 0 : _c.uri) === null || _d === void 0 ? void 0 : _d.toString());
        const res = yield vscode_1.commands.executeCommand(commands_1.nbCommands.newFromTemplate, ...params);
        if ((0, utils_2.isString)(res)) {
            let newFile = utils_2.FileUtils.toUri(res, true);
            yield vscode_1.window.showTextDocument(newFile, { preview: false });
        }
        else if (Array.isArray(res)) {
            for (let r of res) {
                if ((0, utils_2.isString)(r)) {
                    let newFile = utils_2.FileUtils.toUri(r, true);
                    yield vscode_1.window.showTextDocument(newFile, { preview: false });
                }
            }
        }
...
const newProject = (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (yield (0, utils_1.isNbCommandRegistered)(commands_1.nbCommands.newProject)) {
        const res = yield vscode_1.commands.executeCommand(commands_1.nbCommands.newProject, (_a = (0, utils_1.getContextUriFromFile)(ctx)) === null || _a === void 0 ? void 0 : _a.toString());
        if ((0, utils_2.isString)(res)) {
            let newProject = utils_2.FileUtils.toUri(res, true);
