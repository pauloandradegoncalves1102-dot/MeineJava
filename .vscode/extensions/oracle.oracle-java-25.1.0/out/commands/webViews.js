...
*/
const action_1 = require("../webviews/jdkDownloader/action");
...
const invokeSelectJdk = () => __awaiter(void 0, void 0, void 0, function* () {
    const jdkDownloader = new action_1.JdkDownloaderAction();
    jdkDownloader.invokeListener({
        command: view_1.JdkDownloaderView.DOWNLOAD_CMD,
...
exports.registerWebviewCommands = [{
        ...
        command: commands_1.extCommands.selectJdk,
