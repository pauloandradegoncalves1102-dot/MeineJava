...
const goToTest = (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (yield (0, utils_1.isNbCommandRegistered)(commands_1.nbCommands.goToTest)) {
        try {
            const res = yield vscode_1.commands.executeCommand(commands_1.nbCommands.goToTest, (_d = (0, utils_1.getContextUriFromFile)(ctx)) === null || _d === void 0 ? void 0 : _d.toString());
            if ("errorMessage" in res) {
                throw new Error(res.errorMessage);
            }
            (_e = res === null || res === void 0 ? void 0 : res.providerErrors) === null || _e === void 0 ? void 0 : _e.map((error) => {
                if (error === null || error === void 0 ? void 0 : error.message) {
                    vscode_1.window.showErrorMessage(error.message);
                }
            });
            if ((_f = res === null || res === void 0 ? void 0 : res.locations) === null || _f === void 0 ? void 0 : _f.length) {
                if (res.locations.length === 1) {
                    ...
                    const filePath = utils_2.FileUtils.toUri(file);
                    ...
                    if (selected) {
                        try {
                            for (var _g = true, selected_1 = __asyncValues(selected), selected_1_1; selected_1_1 = yield selected_1.next(), _a = selected_1_1.done, !_a; _g = true) {
                                _c = selected_1_1.value;
                                _g = false;
                                const filePath = _c;
                                // If in the future the GoToTest returns URI locations then pass true as an extra parameter to FileUtils.toUri 
                                let file = utils_2.FileUtils.toUri(filePath);
                            ...
                            try {
                                if (!_g && !_a && (_b = selected_1.return)) yield _b.call(selected_1);
                            }
...
const openStackHandler = (uri, methodName, fileName, line) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (location) {
        const lNum = line - 1;
        vscode_1.window.showTextDocument(utils_2.FileUtils.toUri(location, true), { selection: new vscode_1.Range(new vscode_1.Position(lNum, 0), new vscode_1.Position(lNum, 0)) });
    }
    else {
        if (methodName) {
