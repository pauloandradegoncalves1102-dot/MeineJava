...
exports.Visualizer = exports.TreeViewService = void 0;
...
function createTreeViewService(log, c) {
    const d = vscode.commands.registerCommand(commands_1.extCommands.projectDeleteEntry, function (args) {
        return __awaiter(this, void 0, void 0, function* () {
            let v = args;
    ...
    globalState_1.globalState.getExtensionContextInfo().pushSubscription(d);
