                ...
                if (currentNode) {
                    ...
                    if (path.length >= 1 && 'configurations' == path[0]) {
                        ...
                        if (path.length == 1) {
                            ...
                            completionItems = vscode_1.commands.executeCommand(constants_1.extConstants.COMMAND_PREFIX + '.project.configuration.completion', uri);
                        }
                        else {
                            ...
                            if (currentNode.type == 'property' && currentNode.parent) {
                                ...
                                completionItems = vscode_1.commands.executeCommand(constants_1.extConstants.COMMAND_PREFIX + '.project.configuration.completion', uri, attributesMap, propName);
                            }
                            else {
                                let attributesMap = getAttributes(node);
                                // Get additional possible attributes:
                                completionItems = vscode_1.commands.executeCommand(constants_1.extConstants.COMMAND_PREFIX + '.project.configuration.completion', uri, attributesMap);
                            }
                        }
