...
const jdkDownload_1 = require("../../telemetry/events/jdkDownload");
const utils_2 = require("../../telemetry/utils");
class JdkDownloaderAction {
    constructor() {
        this.DOWNLOAD_DIR = path.join(__dirname, 'jdk_downloads');
        this.startTimer = null;
        this.invokeListener = (message) => __awaiter(this, void 0, void 0, function* () {
            const { command, id, jdkVersion, jdkOS, jdkArch, installType } = message;
            if (command === view_1.JdkDownloaderView.DOWNLOAD_CMD) {
        ...
        this.startInstallation = () => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                this.startTimer = (0, utils_2.getCurrentUTCDateInSeconds)();
        ...
        this.installationCompletion = () => __awaiter(this, void 0, void 0, function* () {
            ...
            yield vscode_1.window.showInformationMessage(dialogBoxMessage);
        });
        this.jdkInstallationManager = () => __awaiter(this, void 0, void 0, function* () {
            const startingInstallationMessage = localiser_1.l10n.value("jdk.downloader.message.downloadingAndCompletingSetup", {
                jdkType: view_1.JdkDownloaderView.getJdkLabel(this.jdkType),
        ...
        this.generateDownloadUrl = () => {
            let baseDownloadUrl = '';
            if (this.jdkType === view_1.JdkDownloaderView.JDK_TYPE.openJdk) {
            ...
            else if (this.jdkType === view_1.JdkDownloaderView.JDK_TYPE.oracleJdk) {
        ...
        this.downloadAndVerify = () => __awaiter(this, void 0, void 0, function* () {
            ...
            const currentTime = (0, utils_2.getCurrentUTCDateInSeconds)();
            const downloadTelemetryEvent = {
                vendor: this.jdkType,
            ...
            const event = new jdkDownload_1.JdkDownloadEvent(downloadTelemetryEvent);
            telemetry_1.Telemetry.sendTelemetry(event);
        });
        ...
        this.rmPreviousMatchingDownloads = () => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                for (var _d = true, matchingOldDirs_1 = __asyncValues(matchingOldDirs), matchingOldDirs_1_1; matchingOldDirs_1_1 = yield matchingOldDirs_1.next(), _a = matchingOldDirs_1_1.done, !_a; _d = true) {
                    _c = matchingOldDirs_1_1.value;
                    _d = false;
                    const oldDirName = _c;
                    yield fs.promises.rm(path.join(this.DOWNLOAD_DIR, oldDirName), { recursive: true });
                }
            }
            catch (e_1_1) { e_1 = { error: e_1_1 }; }
            finally {
                try {
                    if (!_d && !_a && (_b = matchingOldDirs_1.return)) yield _b.call(matchingOldDirs_1);
                }
            ...
            fs.unlink(this.downloadFilePath, (err) => __awaiter(this, void 0, void 0, function* () {
                if (err) {
                    ...
                    if (tempDirPath && fs.existsSync(tempDirPath)) {
                        yield fs.promises.rm(tempDirPath, { recursive: true });
                    }
                    if (newDirPath !== null) {
                        yield this.installationCompletion();
                    }
        ...
        this.handleJdkPaths = (directoryName, parentPath, osType) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (fs.existsSync(directoryPath)) {
                ...
                if (selected === yesLabel) {
                    yield fs.promises.rm(directoryPath, { recursive: true });
                }
