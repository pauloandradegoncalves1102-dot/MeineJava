...
exports.isNetbeansVerboseEnabled = exports.isNbJavacDisabledHandler = exports.userdirHandler = exports.isDarkColorThemeHandler = exports.lspServerVmOptionsHandler = exports.projectSearchRootsValueHandler = exports.projectJdkHomeValueHandler = exports.jdkHomeValueHandler = exports.inspectConfiguration = exports.getBuiltinConfigurationValue = exports.updateConfigurationValue = exports.getConfigurationValue = exports.getConfiguration = void 0;
...
const inspectConfiguration = (config) => {
    return vscode_1.workspace.getConfiguration().inspect(config);
};
...
const projectJdkHomeValueHandler = () => {
    return (0, exports.getConfigurationValue)(configuration_1.configKeys.projectJdkHome, null);
};
exports.projectJdkHomeValueHandler = projectJdkHomeValueHandler;
