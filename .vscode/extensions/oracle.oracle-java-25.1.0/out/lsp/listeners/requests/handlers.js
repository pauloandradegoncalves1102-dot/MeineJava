...
const inputBoxRequestHandler = (param) => __awaiter(void 0, void 0, void 0, function* () {
    return yield vscode_1.window.showInputBox({ title: param === null || param === void 0 ? void 0 : param.title, prompt: param === null || param === void 0 ? void 0 : param.prompt, value: param === null || param === void 0 ? void 0 : param.value, password: param === null || param === void 0 ? void 0 : param.password, ignoreFocusOut: param === null || param === void 0 ? void 0 : param.ignoreFocusOut });
});
...
const getNotebookCellStateHandler = (param) => {
    const notebookInstance = vscode_1.workspace.notebookDocuments.find(notebook => notebook.uri.toString() === param.notebookUri);
    const cellInstance = notebookInstance === null || notebookInstance === void 0 ? void 0 : notebookInstance.getCells().find(cell => cell.document.uri.toString() === param.cellUri);
...
exports.requestListeners = [{
        ...
        type: protocol_1.NotebookCellStateRequest.type,
