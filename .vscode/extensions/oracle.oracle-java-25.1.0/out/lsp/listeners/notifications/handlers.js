...
const workspaceChange_1 = require("../../../telemetry/events/workspaceChange");
const telemetry_1 = require("../../../telemetry/telemetry");
const jdkFeature_1 = require("../../../telemetry/events/jdkFeature");
...
const telemetryEventHandler = (param) => {
    if (workspaceChange_1.WorkspaceChangeEvent.NAME === (param === null || param === void 0 ? void 0 : param.name)) {
        const { projectInfo, numProjects, lspInitTimeTaken, projInitTimeTaken } = param === null || param === void 0 ? void 0 : param.properties;
        const eventData = {
            projectInfo,
            numProjects,
            lspInitTimeTaken,
        ...
        const workspaceChangeEvent = new workspaceChange_1.WorkspaceChangeEvent(eventData);
        telemetry_1.Telemetry.sendTelemetry(workspaceChangeEvent);
        return;
    }
    if (jdkFeature_1.JdkFeatureEvent.NAME === (param === null || param === void 0 ? void 0 : param.name)) {
        const { javaVersion, names, jeps, isPreviewEnabled } = param === null || param === void 0 ? void 0 : param.properties;
        const eventData = {
            jeps,
            names,
            javaVersion,
        ...
        const jdkFeatureEvent = new jdkFeature_1.JdkFeatureEvent(eventData);
        telemetry_1.Telemetry.sendTelemetry(jdkFeatureEvent);
        return;
    }
...
const notebookCellExecutionResultHandler = (params) => __awaiter(void 0, void 0, void 0, function* () {
    yield kernel_1.notebookKernel.handleCellExecutionNotification(params);
});
exports.notificationListeners = [{
        ...
        type: protocol_1.NotebookCellExecutionResult.type,
